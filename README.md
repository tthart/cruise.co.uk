...
- Use CSS, HTML and/or JavaScript  to display the results in an organised/tidy fashion and so that it responds well whether viewing on a Desktop or Mobile Device (Android/IOS)
- You can optionally use additional programming languages
